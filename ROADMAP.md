...
6. ✅ **Campo de futebol 5v5 animado:** 10 jogadores com formação que se movem; **campo normal** (sem divisórias — a orientação de zona fica só na barra de cima). A **bola é a protagonista**: passes entre os 5, e no gol há **zoom + câmera lenta + fogo + a bola estufando a rede**. Cartas com **valores claros** e log narrado como futebol.
